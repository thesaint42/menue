...
if [ "$1" = "--cleanup" ]; then
    ...
    TO_DELETE=(
        ...
        "debug_nav.php"
        "debug_orders.php"
        "debug_user_projects.php"
        "error_access_denied.php"
        "fix_features.php"
        "fix_names.php"
        "fix_reporting_user.php"
        "index_v2_backup.php"
        "index_v3.php"
        "install.php.done"
        "migrate_categories.php"
        "PROJECT_ASSIGNMENT_WIP.md"
        "refactor_guests.py"
        "refactor_guests_v2.py"
        "setup_restore.php"
        "show_names.php"
        "test_orders.php"
        "update_projektadmin_features.php"
        "update_reporter_role.php"
